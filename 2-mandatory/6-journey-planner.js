...
*/
function isAccessibleByTransportMode(transportModes, transportModeString) {
  return transportModes.includes(transportModeString);
}
...
function journeyPlanner(locations, transportMode) {
  ...
  return locations.filter(x => x.includes(transportMode)).map(x => getLocationName(x));
}
